...
st.write("This document outlines the features and functionalities of the Resume Generator and Customization Application. This application allows users to input their data and generate a resume in DOCX format, with options for customization through various design templates.")

create=st.button("Create Your Resume!")
if create:
    switch_page("Create_Resume")
